const model = (() => {
   ...
   const subjects = ['bangla-1', 'bangla-2', 'english-1', 'english-2', 'ict', 'higher-math-1', 'higher-math-2', 'physics-1', 'physics-2', 'chemistry-1', 'chemistry-2', 'biology-1', 'biology-2']
   const subjectsText = ['Bangla-1', 'Bangla-2', 'English-1', 'English-2', 'ICT', 'Higher Math-1', 'Higher Math-2', 'Physics-1', 'Physics-2', 'Chemistry-1', 'Chemistry-2', 'Biology-1', 'Biology-2']
   ...
   return {
      ...
      renderSubjectsGraph: (subjects, data, subjectsText=model.getSubjectsTexts()) => {
         ...
         subjects.forEach(cur => {
            ...
            else document.querySelector(`.stats__cont .${cur} p`).textContent = '-'
